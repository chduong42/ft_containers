...
/*   Updated: 2023/02/20 14:57:25 by chduong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline static int	__test_operator_assign(void)
{
	...
	try
	{
		...
		for (idx = 0U ; idx < g_string_size ; ++idx)
		{
			...
			if (memcmp((void*)&ft_rit0, (void*)&ft_rit1, sizeof(ft_rit0)) != memcmp(&std_rit0, &std_rit1, sizeof(std_rit0)))
				return EXIT_FAILURE;
			...
			if (memcmp((void*)&ft_rit0, (void*)&ft_rit2, sizeof(ft_rit0)) != memcmp(&std_rit0, &std_rit2, sizeof(std_rit0)))
				return EXIT_FAILURE;
		}
	}
	catch (std::exception const &e)
