...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/18 16:07:39 by chduong           #+#    #+#             */
/*   Updated: 2023/02/18 18:30:08 by chduong          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	template <class Key, class T, class getKey, class Compare, class Alloc = std::allocator<RBNode<T> > >
	class RBTree {
		public:
